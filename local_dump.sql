...
\restrict XrCZNhtK3F7r7Ec26myAHcHRab5FSCTDZ8C9f3oQDfa4hqGsxrJ2h8kWwY9zoe9
...
DROP POLICY IF EXISTS "Restrict trainers details insert to admin" ON public.trainers;
...
DROP POLICY IF EXISTS "Enable all for self only" ON public.notifications;
DROP POLICY IF EXISTS "Enable all for self only" ON public.hydration_logs;
DROP POLICY IF EXISTS "Enable all for self only" ON public.calorie_logs;
...
DROP POLICY IF EXISTS "Enable SELECT for trainer only" ON public.trainer_earnings;
...
DROP POLICY IF EXISTS "Enable SELECT for self or admin" ON public.user_profiles;
...
DROP POLICY IF EXISTS "Enable INSERT for self or admin" ON public.user_profiles;
...
DROP POLICY IF EXISTS "Enable DELETE for self or admin" ON public.user_profiles;
...
ALTER TABLE IF EXISTS ONLY public.trainer_earnings DROP CONSTRAINT IF EXISTS trainer_earnings_trainer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.hydration_logs DROP CONSTRAINT IF EXISTS hydration_logs_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.credit_transactions DROP CONSTRAINT IF EXISTS credit_transactions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.calorie_logs DROP CONSTRAINT IF EXISTS calorie_logs_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.bookings DROP CONSTRAINT IF EXISTS bookings_client_id_fkey;
...
DROP TRIGGER IF EXISTS trg_dispatch_audit_notification ON public.booking_state_events;
DROP TRIGGER IF EXISTS trg_device_token_cleanup ON public.device_tokens;
DROP INDEX IF EXISTS public.unique_trainer_slot_reservation;
...
ALTER TABLE IF EXISTS ONLY public.trainers DROP CONSTRAINT IF EXISTS trainers_name_key;
ALTER TABLE IF EXISTS ONLY public.trainer_workout_assignments DROP CONSTRAINT IF EXISTS trainer_workout_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.trainer_earnings DROP CONSTRAINT IF EXISTS trainer_earnings_pkey;
ALTER TABLE IF EXISTS ONLY public.trainer_applications DROP CONSTRAINT IF EXISTS trainer_applications_pkey;
ALTER TABLE IF EXISTS ONLY public.trainer_applications DROP CONSTRAINT IF EXISTS trainer_applications_phone_key;
ALTER TABLE IF EXISTS ONLY public.slot_reservations DROP CONSTRAINT IF EXISTS slot_reservations_pkey;
ALTER TABLE IF EXISTS ONLY public.push_delivery_logs DROP CONSTRAINT IF EXISTS push_delivery_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_pkey;
ALTER TABLE IF EXISTS ONLY public.hydration_logs DROP CONSTRAINT IF EXISTS hydration_logs_pkey;
...
ALTER TABLE IF EXISTS ONLY public.calorie_logs DROP CONSTRAINT IF EXISTS calorie_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.bookings DROP CONSTRAINT IF EXISTS bookings_pkey;
ALTER TABLE IF EXISTS ONLY public.booking_state_events DROP CONSTRAINT IF EXISTS booking_state_events_pkey;
...
DROP TABLE IF EXISTS public.trainer_workout_assignments;
DROP TABLE IF EXISTS public.trainer_earnings;
DROP TABLE IF EXISTS public.trainer_applications;
DROP TABLE IF EXISTS public.slot_reservations;
DROP TABLE IF EXISTS public.push_delivery_logs;
...
DROP TABLE IF EXISTS public.calorie_logs;
DROP TABLE IF EXISTS public.bookings;
DROP TABLE IF EXISTS public.booking_state_events;
DROP TABLE IF EXISTS public.addresses;
DROP FUNCTION IF EXISTS public.verify_session_otp(p_booking_id text, p_entered_otp text);
DROP FUNCTION IF EXISTS public.verify_and_start_session(booking_id text, entered_otp text);
DROP FUNCTION IF EXISTS public.validate_booking_transition();
DROP FUNCTION IF EXISTS public.transfer_credits(p_to_phone text, p_amount integer);
DROP FUNCTION IF EXISTS public.trainer_check_in(p_booking_id text);
DROP FUNCTION IF EXISTS public.trainer_accept_booking(p_booking_id text);
DROP FUNCTION IF EXISTS public.submit_trainer_report(p_booking_id text, p_questionnaire jsonb);
DROP FUNCTION IF EXISTS public.submit_customer_review(p_booking_id text, p_rating_details jsonb);
DROP FUNCTION IF EXISTS public.start_travel(p_booking_id text);
DROP FUNCTION IF EXISTS public.start_session(p_booking_id text);
DROP FUNCTION IF EXISTS public.send_booking_reminders();
DROP FUNCTION IF EXISTS public.reschedule_booking(p_booking_id text, p_new_date text, p_new_time text);
DROP FUNCTION IF EXISTS public.reject_trainer_application(app_id text);
DROP FUNCTION IF EXISTS public.reassign_booking_trainer(p_booking_id text, p_action text);
DROP FUNCTION IF EXISTS public.purchase_credits(p_plan_name text, p_credits integer, p_amount text);
DROP FUNCTION IF EXISTS public.process_pending_acceptance_bookings();
DROP FUNCTION IF EXISTS public.parse_booking_start_time(b_date text, b_time text);
DROP FUNCTION IF EXISTS public.on_notification_inserted();
DROP FUNCTION IF EXISTS public.on_booking_status_updated();
DROP FUNCTION IF EXISTS public.mark_trainer_arrived(p_booking_id text);
DROP FUNCTION IF EXISTS public.is_local_development();
DROP FUNCTION IF EXISTS public.is_admin(user_id text);
DROP FUNCTION IF EXISTS public.handle_no_show(p_booking_id text, p_no_show_type text);
DROP FUNCTION IF EXISTS public.handle_device_token_cleanup();
DROP FUNCTION IF EXISTS public.get_server_time();
DROP FUNCTION IF EXISTS public.get_profile_credits(p_profile_id text);
DROP FUNCTION IF EXISTS public.get_client_assessment_history(p_client_id text);
DROP FUNCTION IF EXISTS public.expire_stale_bookings();
DROP FUNCTION IF EXISTS public.dispatch_audit_notification();
DROP FUNCTION IF EXISTS public.create_user_with_profile(user_row jsonb, profile_row jsonb);
DROP FUNCTION IF EXISTS public.create_booking(p_booking_id text, p_workout_id text, p_scheduled_start_at timestamp with time zone, p_scheduled_end_at timestamp with time zone, p_assigned_trainer_id text, p_trainer_note text);
DROP FUNCTION IF EXISTS public.complete_session(p_booking_id text);
DROP FUNCTION IF EXISTS public.close_session(p_booking_id text);
DROP FUNCTION IF EXISTS public.cancel_booking(p_booking_id text);
DROP FUNCTION IF EXISTS public.auto_accept_booking(p_booking_id text);
DROP FUNCTION IF EXISTS public.approve_trainer_application(app_id text);
DROP FUNCTION IF EXISTS public.apply_auto_acceptances();
DROP FUNCTION IF EXISTS public.acknowledge_auto_accept(p_booking_id text);
...
\unrestrict XrCZNhtK3F7r7Ec26myAHcHRab5FSCTDZ8C9f3oQDfa4hqGsxrJ2h8kWwY9zoe9
