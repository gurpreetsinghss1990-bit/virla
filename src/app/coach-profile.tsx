    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
        ...
        <View className="w-full aspect-[16/12] relative bg-zinc-100">
          ...
          />
          {coach.verifiedBadge && (
            <View className="absolute top-4 right-4 bg-indigo-600 px-3.5 py-1.5 rounded-full flex-row items-center gap-1 shadow-sm">
              ...
              <View className="gap-2">
                {coach.certifications.map((cert, i) => (
                  <View key={i} className="flex-row items-center bg-zinc-50/50 border border-zinc-100/50 p-3.5 rounded-2xl">
                    <Ionicons name="ribbon-outline" size={16} color="#4F46E5" className="mr-3" />
