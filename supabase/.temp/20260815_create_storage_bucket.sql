...
drop policy if exists "Allow public select access for trainer-documents" on storage.objects;
...
drop policy if exists "Allow public insert access for trainer-documents" on storage.objects;
...
drop policy if exists "Allow public update access for trainer-documents" on storage.objects;
