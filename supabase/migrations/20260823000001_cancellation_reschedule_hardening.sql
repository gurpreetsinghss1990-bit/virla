-- Migration: Hardening Booking Cancellation & Rescheduling Business Rules
-- Created At: 2026-08-23

-- 1. Redefine cancel_booking with a 2-hour window
...
-- 2. Define reschedule_booking function with a 2-hour window and validations
...
BEGIN
  ...
  -- Double-booking and buffer check (only if trainer is assigned)
  IF v_booking.trainer_id != 'searching' THEN
    IF EXISTS (
