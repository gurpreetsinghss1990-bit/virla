-- Migration: Hardening create_booking to support trainer_note (client preparation note) and adding secure get_client_assessment_history
...
-- Secure definer history retrieval helper for One-Brain assessments
