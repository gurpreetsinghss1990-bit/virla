-- Migration: Fix Registered Recipient Lookup with Phone Normalization
-- Created At: 2026-08-30

-- 1. Redefine find_recipient_by_phone to use last-10-digit normalization and support customer/trainer roles
...
-- 2. Redefine transfer_credits to use last-10-digit normalization and support customer/trainer roles
