-- Migration: Add Atomic Trainer Approval and Rejection RPC Functions
-- Created At: 2026-08-19

-- 1. Create approve_trainer_application RPC
...
-- 2. Create reject_trainer_application RPC
CREATE OR REPLACE FUNCTION public.reject_trainer_application(app_id text)
RETURNS void AS $$
DECLARE
  app_row public.trainer_applications%ROWTYPE;
  user_id text;
